  ...
  return (
    ...
    >
      {yesPressed ? (
        <>
          <img
            className="romantic-float"
            src="https://media.tenor.com/gUiu1zyxfzYAAAAi/bear-kiss-bear-kisses.gif"
          />

          <div className="sky-slideshow">
            <img
              key={currentPhoto}
          ...
          <p className="typing-text text-center max-w-xl">
            From the moment you came into my life,
            everything became brighter and more beautiful.
            You are my happiness, my peace, my forever.
            I love you more than words can ever explain 💖   Gulaaabooooooo 🌹
          </p>
        </>
      ) : (
        <>
